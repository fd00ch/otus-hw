...
///
        ...
        var firstClientAddress = new Address("10, Liberty str.");
        var firstClientPhone1 = new Phone("+79998887777");
        ...
        var secondClientPhone1 = new Phone("+79998882222");
        var secondClient = new Client("dbServiceSecond");
        secondClient.setAddress(secondClientAddress);
        secondClient.addPhones(List.of(secondClientPhone1));
